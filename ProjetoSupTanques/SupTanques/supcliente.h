...
protected:
  ...
  bool isConnected() const {return /* MODIFICAR */ tcp_mysocket_cli.connected() ;}
  ...
  void join_if_joinable() {/* ACRESCENTAR */  if(thr_cliente.joinable()) thr_cliente.join();}
...
private:
  ...
  // Sao chamadas na thread: nao podem usar funcoes proibidas nesse contexto.
  //
