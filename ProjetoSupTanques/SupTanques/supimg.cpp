...
/// Limpa os pontos da imagem
/// Como pode ser chamada pela thread, nao pode alterar diretamente a interface.
void SupImg::clearPoints()
{
  points.clear();
  // Nao redesenha a imagem.
  // Serah feito na proxima chamada a drawImg
}
